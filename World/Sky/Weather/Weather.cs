...
public class Weather : ScriptableObject {
    ...
    public float globalFog = 0.0001f, fogStart, fogEnd;
    public bool areLowClouds, areHighClouds, areCirrusClouds, areCloseClouds;
    public float lowCloudDensity, highCloudDensity;
    public Color lowCloudColor, highCloudColor, fogColor;
}
