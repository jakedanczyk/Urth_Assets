...
[Serializable]
public class Block16Surface : Block16
{
    //Base block constructor
    public Block16Surface()
    {
    ...
    protected override MeshData FaceDataUp(Chunk16 chunk16, int x, int y, int z, MeshData meshData)
    {
    ...
    protected override MeshData FaceDataDown(Chunk16 chunk16, int x, int y, int z, MeshData meshData)
    {
        var terrainGen = new TerrainGen();
        float nw = terrainGen.StoneHeight(16 * x - 8f + chunk16.pos.x, 16 * y + chunk16.pos.y, 16 * z + 8f + chunk16.pos.z) - chunk16.pos.y;
        float ne = terrainGen.StoneHeight(16 * x + 8f + chunk16.pos.x, 16 * y + chunk16.pos.y, 16 * z + 8f + chunk16.pos.z) - chunk16.pos.y;
