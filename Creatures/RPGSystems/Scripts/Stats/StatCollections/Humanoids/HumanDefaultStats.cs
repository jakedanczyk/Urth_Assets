...
public class HumanDefaultStats : CreatureStats
{
    protected override void ConfigureStats()
    {
        ...
        var walkSpeed = CreateOrGetStat<RPGDerived>(RPGStatType.WalkSpeed);
        walkSpeed.StatName = "Walking Speed";
        walkSpeed.StatBaseValue = 5;
        walkSpeed.AddLinker(new RPGStatLinkerLinear(CreateOrGetStat<RPGAttribute>(RPGStatType.Speed), 075f, -400f));
